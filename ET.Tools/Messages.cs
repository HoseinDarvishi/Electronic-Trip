namespace ET.Tools
{
   ...
   {
      public const string Success = "عملیات موفقیت آمیز بود";
      public const string Warning = "خطایی رخ داده";
      ...
      public const string SuccessEditRole = "نقش با موفقیت ویرایش شد";
